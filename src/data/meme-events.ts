...
export const AUTHORS: Record<string, SocialAuthor[]> = {
  kol: [
    { name: 'CryptoGuru', handle: '@CryptoGuru', avatar: '🧙‍♂️', type: 'kol', followers: '1.2M', verified: true },
  ...
  dev: [
    ...
    { name: 'Based Dev', handle: '@BasedDev420', avatar: '🛠️', type: 'dev', followers: '12K', verified: false },
    { name: 'CTO', handle: '@ProjectCTO', avatar: '👩‍💻', type: 'dev', followers: '8K', verified: true },
  ],
  anon: [
  ...
  news: [
    ...
    { name: 'The Block', handle: '@TheBlock__', avatar: '🗞️', type: 'news', followers: '1.8M', verified: true },
    { name: 'Decrypt', handle: '@decryptmedia', avatar: '🔐', type: 'news', followers: '900K', verified: true },
    { name: 'CryptoSlate', handle: '@CryptoSlate', avatar: '📡', type: 'news', followers: '2.1M', verified: true },
    { name: 'DL News', handle: '@DLNews', avatar: '📋', type: 'news', followers: '400K', verified: true },
  ],
  celebrity: [
  ...
  exchange: [
    ...
    { name: 'KuCoin', handle: '@kucoin', avatar: '🟢', type: 'exchange', followers: '3M', verified: true },
  ...
  bot: [
    ...
    { name: 'Copy Trade Bot', handle: '@CopyWhales', avatar: '⚙️', type: 'bot', followers: '25K', verified: false },
  ],
  scammer: [
